"""Purpose: Build the Goal 011 deterministic release package skeleton.

The helper packages only managed repository DB source files into db/dist and
generates skeleton release metadata without Docker, Oracle, DB connections, DDL,
or DML. It exists to prove the packaging contract before functional release
management objects are added.
"""
...
def require_repository_root() -> None:
    required = ["AGENTS.md", "docs/codex-goals/goal-011-release-packaging-workflow.md"]
